...
# WRITE the file with real newlines (one row per line) — use '\n' so Python writes actual newlines
lines = [
    'date_col',
    '2020-01-05',
    '01/06/2021',
...
# Note: using '\n' (single backslash) in the Python source creates real newline characters in the file.
p.write_text('\n'.join(lines) + '\n', encoding='utf-8')
